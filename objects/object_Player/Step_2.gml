...
if (hasWeapon)
{
	...
	{	
		// Up
		//if ((image_angle > 60) && (image_angle < 120)) with (Player sprite_index = spriteDirection[1];
		// Down
		//if ((image_angle > 240) && (image_angle < 300)) with (Player sprite_index = spriteDirection[2];
		// Left
